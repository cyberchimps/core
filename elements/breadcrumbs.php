...
function response_yoast_breadcrumbs() {
	...
	if ( response_detect_plugin( array('constants' => array( 'WPSEO_VERSION' ) ) ) ) {
		...
		// check if breadcrumbs are enabled and yoast_breadcrumb exists
...
function response_load_breadcrumbs() {
	...
	// TODO: Only check once maybe on plugin activation and maybe throw alerts that there is a plugin conflict.
