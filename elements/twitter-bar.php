...
function cyberchimps_twitter_bar_element() {
...
add_action ( 'cyberchimps_twitter_bar', 'cyberchimps_twitter_bar_element' );
...
function retrieve_remote_tweets($request_url) {
	...
	$code = (int) wp_remote_retrieve_cyberchimps_code($raw_response);
