...
//    update the drag and drop input field that gets saved to db
    function update_sort(){
        var items = '';
        jQuery( "#right_list li span").each(function(e){
            if( e > 0 ) {
                items += ',' + jQuery(this).data("key");
            }
            else {
                items += jQuery(this).data("key");
            }
