...
(function ($) {
	...
	optionsframeworkMLU = {
		...
		removeFile: function () {
			...
			$('.screenshot').on('click', '.mlu_remove' , function (event) {
				$(this).hide();
				$(this).parents().siblings('.input-append').children('.upload').attr('value', '');
		...
		mediaUpload: function () {
			...
			var formfield,
				...
				tbframe_interval;
			// On Click
			$(".custom_logo_toggle").on("click", "input.upload_button", function () {
