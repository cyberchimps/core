jQuery(document).ready(function (e) {
	var b = function (i) {
		...
		g.find(".right-list .list-items").sortable({update: function () {
			h(e(this).closest(".section-order"))
		}, connectWith: "#" + i + " .left-list .list-items", placeholder: "sortable-placeholder"});
		g.find(".left-list .list-items").sortable({connectWith: "#" + i + " .right-list .list-items", placeholder: "sortable-placeholder"});
		h(g)
	};
...
(function (b) {
	...
	b(".at-field .checkbox-toggle").each(function () {
		b(this).on("change", {id: b(this).attr("id")}, a)
	}).change()
})(jQuery);
(function (b) {
	var a = function (d, c) {
