...
function cyberchimps_init_meta_boxes() {
	...
	$mb
		...
		->tab("iFeature Slider Options")
			...
			->sliderhelp('', __( 'Need Help?', 'cyberchimps_core' ), '')
		/*->tab("Product Options")
			->select('cyberchimps_product_text_align', __( 'Text Align', 'cyberchimps_core' ), '', array('options' => array('Left', 'Right' ) ) )
			...
			->select('cyberchimps_product_type', __( 'Media Type', 'cyberchimps_core' ), '', array('options' => array('Image', 'Video')) )
		...
		->tab("Boxes Lite Options")
			->single_image('cyberchimps_box_lite_image_one', __( 'First Box Image', 'cyberchimps_core' ), '', array( 'std' => $boxes_lite_image1 ) )
			->text('cyberchimps_box_lite_image_one_link', __( 'Link URL', 'cyberchimps_core' ), '', array( 'std' => 'http://wordpress.org' ) )
			->textarea('cyberchimps_box_lite_image_one_text', __( 'First Box Text', 'cyberchimps_core' ), '', array( 'std' => '' ) )
			->single_image('cyberchimps_box_lite_image_two', __( 'Second Box Image', 'cyberchimps_core' ), '', array( 'std' => $boxes_lite_image2 ) )
			->text('cyberchimps_box_lite_image_two_link', __( 'Link URL', 'cyberchimps_core' ), '', array( 'std' => 'http://wordpress.org' ) )
			->textarea('cyberchimps_box_lite_image_two_text', __( 'Second Box Text', 'cyberchimps_core' ), '', array( 'std' => '' ) )
			->single_image('cyberchimps_box_lite_image_three', __( 'Third Box Image', 'cyberchimps_core' ), '', array( 'std' => $boxes_lite_image3 ) )
			->text('cyberchimps_box_lite_image_three_link', __( 'Link URL', 'cyberchimps_core' ), '', array( 'std' => 'http://wordpress.org' ) )
			->textarea('cyberchimps_box_lite_image_three_text', __( 'Third Box Text', 'cyberchimps_core' ), '', array( 'std' => '' ) )
		->tab("Boxes Options")
