...
function cyberchimps_meta_box() {
    ...
    $new = array(
        array(
            'id'        => 'page_options',
            'title'     => __( 'Page Options', 'cyberchimps' ),
            'post_type' => 'page',
            'context'   => 'normal',
            'priority'  => ''
        ),
    ...
    $fields = array(
        'page_options' => array(
            array(
                ...
                'title'   => __( 'Select Page Layout', 'cyberchimps_core' ),
                'type'    => 'image_select',
            ...
            array(
                ...
                'title' => __( 'Page Title', 'cyberchimps_core' ),
                'type'  => 'checkbox',
                'std'   => 1,
                'desc'  => ''
            ),
            array(
                ...
                'title' => __( 'Page Elements', 'cyberchimps_core' ),
                'type'  => 'section_order',
                'options' => apply_filters( 'cyberchimps_elements_draganddrop_page_options', array(
                    'boxes'              => __( 'Boxes', 'cyberchimps_core' ),
                    'page_section'       => __( 'Page', 'cyberchimps_core' ),
