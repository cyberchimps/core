...
function cyberchimps_init_meta_boxes() {
	...
	$mb
		...
		->tab("Slider Lite Options")
			...
			->single_image('cyberchimps_slider_lite_slide_two_image', __( 'Slide Two Image', 'cyberchimps' ), '', array('std' =>  get_template_directory_uri() . '/elements/lib/images/slider/slide2.jpg'))
			->text('cyberchimps_slider_lite_slide_two_url', __( 'Slide Two Link', 'cyberchimps' ), '', array('std' => 'http://wordpress.org'))
			->single_image('cyberchimps_slider_lite_slide_three_image', __( 'Slide Three Image', 'cyberchimps' ), '', array('std' =>  get_template_directory_uri() . '/elements/lib/images/slider/slide3.jpg'))
